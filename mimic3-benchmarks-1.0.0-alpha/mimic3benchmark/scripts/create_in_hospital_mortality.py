    ...
    for (patient_index, patient) in enumerate(patients):
        ...
        for ts_filename in patient_ts_files:
            with open(os.path.join(patient_folder, ts_filename)) as tsfile:
                ...
                mortality = int(label_df.loc[0]["Mortality"])
                los = 24.0 * label_df.loc[0]['Length of Stay']  # in hours
                if pd.isnull(los):
...
def main():
    ...
    parser.add_argument('root_path', type=str, help="Path to root folder containing train and test sets.", default="../../../data/MIMIC3")
    parser.add_argument('output_path', type=str, help="Directory where the created data should be stored.", default="/data/root")
